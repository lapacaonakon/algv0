            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                <div class="bg-slate-800 p-6 rounded-lg border border-slate-600 relative pt-8">
                    <div class="absolute -top-3 left-4 bg-slate-700 text-emerald-300 text-xs px-3 py-1 rounded-full font-bold uppercase border border-emerald-500 shadow-md">
                        Аналогия 1: Курьер с навигатором
                    </div>
                    <p class="text-slate-300 text-sm mb-4">Курьер выезжает из пиццерии и мысленно «разливает» волну: сначала ближайшая точка, потом следующая по близости и так далее. Как только он <b>приехал</b> в точку — маршрут до неё финальный: дешевле уже не будет, потому что все дороги платные (веса ≥ 0) и любой объезд начинается не ближе, чем он сейчас. Ровно это и делает алгоритм: волна расстояний расходится от старта в порядке возрастания.</p>
                </div>
    ...
    <div class="space-y-8">
        <div class="bg-slate-700/50 p-6 rounded-xl border-l-4 border-rose-500 scroll-mt-10">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                <div class="bg-slate-800 p-6 rounded-lg border border-slate-600 relative pt-8">
                    <div class="absolute -top-3 left-4 bg-slate-700 text-emerald-300 text-xs px-3 py-1 rounded-full font-bold uppercase border border-emerald-500 shadow-md">
                        Аналогия 1: Слухи в деревне
                    </div>
                    <p class="text-slate-300 text-sm mb-4">Новость («до склада можно доехать за 8 минут») расходится по деревне: за один «день» она проходит ровно <b>одно</b> звено — каждый пересказывает только прямым соседям. Чтобы дойти до точки в четырёх пересказах, нужно четыре дня. Отсюда и предел <span class="font-mono text-emerald-300">V − 1</span>: длиннее цепочки пересказов в деревне из V жителей просто не бывает. Порядок, в котором жители говорят, не важен — важен только номер дня.</p>
                </div>
            ...
            <div class="grid grid-cols-1 gap-6 mb-6">
                <div class="bg-slate-800 p-6 rounded-lg border border-slate-600 relative pt-8">
                    ...
                    <ol class="text-sm text-slate-300 space-y-2 list-decimal list-inside ml-2">
                        ...
                        <li>Запускаем от s <b>один</b> Форд—Беллман. Он даёт расстояния h(v) — это наши <b>потенциалы</b>. Заодно он ловит отрицательный цикл: если цикл есть, Джонсон неприменим, и это надо сказать вслух.</li>
