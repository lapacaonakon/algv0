...
pair&lt;Node*, Node*&gt; split(Node* t, int x) {
    ...
    if (t->val &lt;= x) {
        ...
        <div class="bg-slate-700/50 p-6 rounded-xl border-l-4 border-emerald-500 scroll-mt-10">
            ...
            <p class="text-slate-300 text-sm mb-3">Демо-набор страницы — восемь пар, у <b>всех</b> точек различны и ключи, и приоритеты: <code class="bg-slate-950 px-2 py-0.5 rounded text-xs font-mono text-slate-200 border border-slate-800">45 8 · 3 6 · 6 5 · 2 4 · 9 3 · 7 2 · 12 0 · 1 -4</code>. Для такого набора дерево единственно: никакой алгоритм его не «выберет по-другому». Негласные правила на случай совпадений: равные x — идём влево; равные y ломают единственность («кто выше?»), поэтому приоритеты договорились делать различными — например, случайными.</p>
