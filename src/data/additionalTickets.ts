        ...
        <div class="bg-slate-700/50 p-6 rounded-xl border-l-4 border-emerald-500 scroll-mt-10">
            ...
            <div class="bg-slate-900 p-6 rounded-lg border-2 border-rose-500/60 mb-6">
                <p class="text-base sm:text-lg font-bold text-rose-300 uppercase leading-relaxed tracking-wide">
                    <span class="text-white text-2xl">Малый x — огромный y: Х!Й</span><br/>
                    «!» — приоритет: маленький знак, а держит всё слово. Убери «!» — останется набор букв, который стыдно произнести. Убери y из пары — останется обычное дерево поиска, которое при неудачном вводе превращается в палку.<br/>
                    Х — это x (ключ): место по алфавиту. Левее по алфавиту — налево, правее — направо.<br/>
                    «!» — это y (приоритет): кто громче, тот выше. Корень — самый «!». Каждый родитель «!»-нее своих детей. Всегда.<br/>
                    Все стоят по алфавиту, но кричат по «!» — это treap.<br/>
                    Два одинаковых «!»? Выше тот, кто раньше заявил заявку в списке. Два одинаковых x? Идут влево — так записано в уставе.
                </p>
