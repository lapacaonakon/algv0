        ...
        <details class="bg-slate-900/40 rounded-lg border border-slate-700/50 group cursor-pointer mt-6">
            ...
            <div class="p-5 text-sm text-slate-300 space-y-4 cursor-default" onClick="event.stopPropagation()">
                ...
                <p>
                    ...
                    TSP — NP-трудная: полиномиальный алгоритм для неё означал бы P = NP. 
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <div class="bg-slate-900 p-6 rounded-lg border-2 border-dashed border-amber-500/50 relative pt-8">
                    ...
                    <ul class="text-slate-300 text-sm space-y-2 list-disc pl-4">
                        ...
                        <li><strong class="text-white">Теорема Брукса (не путать с жадной!):</strong> для связного графа, который не полный и не нечётный цикл, χ(G) ≤ Δ.</li>
                    </ul>
                </div>
            </div>
